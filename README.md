...
| Hide/show the HUD     | **H**                                                                            | —                                                                                                                   |
| Screenshot            | **R**, or the Camera button in the HUD (desktop only)                            | Camera icon in the HUD                                                                                              |
...
│   │       ├── settings/Preferences/# Branding (logo/background/icons/mobile carousel/entrance splash) + Theme editor (incl. Cursor Effects)
